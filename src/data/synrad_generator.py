...
def get_synrad_test_generator(sevir_catalog,
    ...
    # filt = lambda c: np.logical_and(c.pct_missing==0,np.logical_or(c.file_name.str.contains('2019_0101_0630'),c.file_name.str.contains('LGHT_ALLEVENTS_2019_0601_0701'))) # remove samples with missing radar data
