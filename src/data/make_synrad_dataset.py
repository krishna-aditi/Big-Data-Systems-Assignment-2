...
from synrad_generator import get_synrad_test_generator #, get_synrad_train_generator

parser = argparse.ArgumentParser(description='Make synrad training & test datasets using SEVIR')
parser.add_argument('--sevir_data', type=str, help='location of SEVIR dataset',default='C:\\Users\\krish\\Downloads\\neurips-2020-sevir-master\\neurips-2020-sevir-master\\src\\data')
parser.add_argument('--sevir_catalog', type=str, help='location of SEVIR dataset',default='C:\\Users\\krish\\Downloads\\neurips-2020-sevir-master\\neurips-2020-sevir-master\\src\\data\\CATALOG.csv')
parser.add_argument('--n_chunks', type=int, help='Number of chucks to use (increase if memory limited)',default=25)

parser.add_argument('--output_location', type=str, help='location of SEVIR dataset',default='C:\\Users\\krish\\Downloads\\neurips-2020-sevir-master\\neurips-2020-sevir-master\\data\\interim')
